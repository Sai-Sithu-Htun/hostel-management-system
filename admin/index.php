...
<div style="overflow:hidden;width:fit-content">
	...
	<ul class="ts-profile-nav">
		<li class="ts-account">
			<a href="#" style="margin: 10px;"><img src="img/ts-avatar.jpg" class="ts-avatar hidden-side" alt=""> <?php 
...
<li><a href=".php"><i class="fa fa-cogs"></i>Manage Student</a></li>
<li><a href=".php"><i class="fa fa-user"></i>Register Admins</a></li>
...
<div style="text-align:center">
  ...
  <div class="w3-row" style="padding-top:32px"  id="about">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="img/logo1.jpg" class="w3-round w3-image w3-card-4 " alt="Table Setting" width="600" height="750">
    </div>
