...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/forget.jpg);">
...
?>
<br> Change the Password After login</p>
			<a href="login.php" style="padding: 15px;background-color:grey;border: 15px;border:1px solid black">Back to Login<i class="fa fa-sign-in"></i></a>
...
if(!isset($pwd)) {
?>
    <form id="loginForm" action="" class="mt" method="post">
        ...
        <input type="submit" name="login" class="btn btn-primary btn-block" value="See Password" >
    </form>
<?php 
} 
?>
