...
$query="UPDATE userregistration INNER JOIN student ON userregistration.userID = student.studentID SET Name=?, gender=?, contactNo=?, atdYear=? WHERE userregistration.userID=?";

$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssisi',$Name,$gender,$contactno,$atdYear,$aid);
...
<div class="col-sm-8">
<select name="atdYear" id="atdYear" class="form-control" required="required">
